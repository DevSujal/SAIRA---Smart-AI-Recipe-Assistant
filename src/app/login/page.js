    ...
    return (
        <div className='relative flex justify-center items-center h-screen'>
            ...
            <div className='relative z-10 flex min-w-[900px]   gap-24 text-white bg-black bg-opacity-60  rounded-lg overflow-hidden'>
                ...
                <div className={`login  flex flex-col gap-8  py-10 pl-12 transition-all duration-1000 ${isLogin ? 'translate-x-0 opacity-100 z-20' : 'translate-x-full opacity-0'}`}>
                ...
                <div className={`register flex flex-col gap-8 py-10 pr-12 transition-all duration-1000 ${!isLogin ? 'translate-x-0 opacity-100 z-20' : '-translate-x-full opacity-0'}`}>
                ...
                <div className={`swap z-30 absolute bg-[url('/fp3.avif')] bg-cover w-[50%] bg-center h-full transition-transform duration-1000 ${!isLogin ? 'translate-x-0' : 'translate-x-full'}`}>

                    <div className='bg-black bg-opacity-30 w-full h-full p-6  flex justify-center items-center'>
                        <div className=' flex flex-col items-center gap-3 mb-10'>
                            <h1 className='text-3xl font-semibold'>Welcome back</h1>
                            <p>Lorem, ipsum dolor sit amet consectetur  elit. Nihil porro placeat, odio quia cumque a sed vitae dolor nam esse rerum sit possimus ame. A neque fuga. Lorem ipsum dolor sit amet.</p>
                            <button onClick={toggleForm} className='border-2 hover:border-green-500 hover:bg-green-500 px-4 py-2 rounded-lg font-medium'>{isLogin ? "Sign up" : "Sign in"}</button>
                        </div>
                    </div>
