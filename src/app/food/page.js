...
const page = ({ }) => {
  const [foodItem, setfoodItem] = useState({
    ...
    "n_ingredients": 6,
    "image": "https://homefoodi.com/wp-content/uploads/2023/04/delicious-brazilian-food-top-view.jpg",
    "rating": 9
  }
  )
  const recipes = [
    ...
    },
    {
      ...
      submitted: "1/25/2005",
      tags: [
        "15-minutes-or-less", "time-to-make", "course", "preparation", 
        "low-protein", "healthy", "5-ingredients-or-less", 
        "condiments-etc", "easy", "dietary", "low-sodium", 
        "low-in-something", "3-steps-or-less"
      ],
      nutrition: [79.2, 3.0, 58.0, 0.0, 0.0, 6.0, 5.0],
      n_steps: 2,
      steps: [
        "In medium size bowl, coarsely mash cranberry sauce.",
        "Stir in sour cream and horseradish until well blended."
      ],
  ...
  return (
    <div >
      ...
      <RecipeContainer tittle={"Similar recipes"} recipes={recipes} />
    </div>
  )
}
